...
I'm a **Software & AI Engineer** with a Master's in Computer Science, building production-grade systems that span AI/ML pipelines, full-stack applications, and cloud-native infrastructure.

**Currently focused on:**
- 🤖 Fine-tuning LLMs (GPT-4o, T5) and building RAG & semantic search solutions with LangChain, Hugging Face, and vector databases
- ☁️ Deploying end-to-end ML workflows on AWS SageMaker and Azure ML
- ⚡ Designing high-throughput RESTful microservices with Spring Boot and NestJS supporting tens of thousands of daily transactions
...
- 🌐 [Portfolio](https://mohithk.netlify.app/)
